...
import { MAP_PIN, USER_MAP_PIN } from '../../assets/images';
    ...
    <View style={styles.addressContainer}>
      <MapView
        ...
        {destinationAddress && destinationAddress.latitude && (
          <Marker coordinate={destinationAddress} identifier="source">
            <Svg width={pinWidth} height={pinHeight}>
              <Image href={USER_MAP_PIN} width={pinWidth} height={pinHeight} />
            </Svg>
          </Marker>
        )}
      </MapView>
