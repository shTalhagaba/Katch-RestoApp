...
import { DELETE_USER, GET_USER_WALLET } from '../../components/GraphQL';
...
const AccountSettings = ({
  ...
  const onDisableAccountAlert = () => {
    Alert.alert(
      'Deleting Account',
      'Are you sure you want to Delete the account? Once Deleted this cannot be undone.',
      [
        {
          text: 'Yes',
    ...
    <View>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <IIcons name="trash-outline" size={20} color={GS.logoRed} />
          <RText style={{ marginRight: 'auto', marginLeft: 10, fontSize: 14, color: GS.logoRed }}>
            Delete Account
          </RText>
          <MIIcon name="chevron-right" size={20} color={GS.logoRed} />
        </TouchableOpacity>
        <TouchableOpacity
