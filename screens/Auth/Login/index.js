...
import { animateLayout, getGreetings, goToWhatsapp } from '../../../components/Helpers';
import { GREEN_WHATSAPP, RAMADAN_BANNER } from '../../../assets/images';
  ...
  const _onSignIn = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/wrong-password') {
        ...
        setErrors({ phoneNumber: 'This account has been deleted.' });
      } else {
