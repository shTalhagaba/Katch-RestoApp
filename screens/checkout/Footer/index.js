...
export const PlaceOrderButton = (props) => {
  const { addressError, _onCheckout, loading, paymentMLoading, selectedPaymentMethod } = props;
  return (
    <View style={styles.placeOrderWrapper}>
      {/* FIXME add conditions here */}
      {addressError === '' && !loading && !paymentMLoading && selectedPaymentMethod > -1 ? (
